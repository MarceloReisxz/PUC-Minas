...
// definir dado
 ...
 int controle = 0;
// identificar
 IO_id ( "EXEMPLO0404 - Method01 - v0.0" );
// ler do teclado
...
// definir dado
 ...
 int contador = 0;
// identificar
 IO_id ( "EXEMPLO0404 - Method02 - v0.0" );
// ler do teclado
 quantidade = IO_readint ( "Entrar com uma quantidade: " );
// repetir para a quantidade de vezes informada
 controle = 1;
...
// definir dado
 ...
 int contador = 0;
// identificar
 IO_id ( "EXEMPLO0404 - Method03 - v0.0" );
// ler do teclado
 quantidade = IO_readint ( "Entrar com uma quantidade: " );
// repetir para a quantidade de vezes informada
 controle = 1;
...
{
// identificar
 IO_id ( "EXEMPLO0404 - Method05 - v0.0" );
// encerrar
 IO_pause ( "Apertar ENTER para continuar" );
} // fim method05 ( )
/**
...
{
// identificar
 IO_id ( "EXEMPLO0404 - Method06 - v0.0" );
// encerrar
 IO_pause ( "Apertar ENTER para continuar" );
} // fim method06 ( )
/**
...
{
// identificar
 IO_id ( "EXEMPLO0404 - Method07 - v0.0" );
// encerrar
 IO_pause ( "Apertar ENTER para continuar" );
} // fim method07 ( )
/**
...
{
// identificar
 IO_id ( "EXEMPLO0404 - Method08 - v0.0" );
// encerrar
 IO_pause ( "Apertar ENTER para continuar" );
} // fim method08 ( )
/**
...
{
// identificar
 IO_id ( "EXEMPLO0404 - Method09 - v0.0" );
// encerrar
 IO_pause ( "Apertar ENTER para continuar" );
} // fim method09 ( )
/**
...
{
// identificar
 IO_id ( "EXEMPLO0404 - Method10 - v0.0" );
// encerrar
 IO_pause ( "Apertar ENTER para continuar" );
} // fim method10 ( )
/*
