...
// definir dado
 ...
 int controle = 0;
// identificar
 IO_id ( "EXEMPLO0408 - Method01 - v0.0" );
// ler do teclado
...
// definir dado
 ...
 int contador = 0;
// identificar
 IO_id ( "EXEMPLO0408 - Method02 - v0.0" );
// ler do teclado
 quantidade = IO_readint ( "Entrar com uma quantidade: " );
// repetir para a quantidade de vezes informada
 controle = 1;
...
// definir dado
 ...
 int contador = 0;
// identificar
 IO_id ( "EXEMPLO0408 - Method03 - v0.0" );
// ler do teclado
 quantidade = IO_readint ( "Entrar com uma quantidade: " );
// repetir para a quantidade de vezes informada
 controle = 1;
...
// definir dado
 ...
 int contador = 0;
// identificar
 IO_id ( "EXEMPLO0408 - Method04 - v0.0" );
// ler do teclado
 quantidade = IO_readint ( "Entrar com uma quantidade: " );
// repetir para a quantidade de vezes informada
 controle = 1;
...
// definir dado
 ...
 bool ok = false;
// identificar
 IO_id ( "EXEMPLO0408 - Method05 - v0.0" );
// ler do teclado
 quantidade = IO_readint ( "Entrar com uma quantidade: " );
// repetir para a quantidade de vezes informada
 controle = 1;
...
// definir dado
 ...
 int contador = 0;
// identificar
 IO_id ( "EXEMPLO0408 - Method06 - v0.0" );
// ler do teclado
...
// definir dado
 ...
 int contador = 0;
// identificar
 IO_id ( "EXEMPLO0408 - Method07 - v0.0" );
// ler do teclado
 palavra = IO_readstring ( "Entrar com uma palavra: " );
// determinar a quantidade de simbolos na palavra
 tamanho = strlen ( palavra );
...
{
// identificar
 IO_id ( "EXEMPLO0408 - Method09 - v0.0" );
// encerrar
 IO_pause ( "Apertar ENTER para continuar" );
} // fim method09 ( )
/**
...
{
// identificar
 IO_id ( "EXEMPLO0408 - Method10 - v0.0" );
// encerrar
 IO_pause ( "Apertar ENTER para continuar" );
} // fim method10 ( )
/*
